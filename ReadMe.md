...
세부적인 선택지는 **option**을 통해 만든다.

**multiple**을 사용하면 다중선택창도 띄울 수 있다,
...
body 태그에 스타일을 주겠다는 뜻으로, 이 부분을 **'선택자(Selector)'**라고 부른다.
...
괄호 안에 'background-color:'와 같은 부분은 **'속성(Property)'**라고 부른다. 
...
그리고 속성 값의 마지막에는 **세미 콜론(;)**이 붙어서 다음 속성 값과 구분한다.
